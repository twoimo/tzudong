 ...
 *
 * Unit 5 is `/backend/deploy/pipeline-control` after the P5 layout move (task 34).
 * Design C2 records this post-P5 path; it moved together with
 * `.github/dependabot.yml` (design "미해석 참조" table, task 34).
 */
export const UNITS = Object.freeze([
  ...
  Object.freeze({ number: 5, ecosystem: 'pip', directory: '/backend/deploy/pipeline-control' }),
