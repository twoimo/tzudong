    ...
    const { data: topReviewedRestaurant } = useQuery({
        ...
        queryFn: async () => {
            try {
                ...
                const maxReviewCount = (maxReviewCountData as { review_count: number | null }).review_count || 0;
                ...
                const { data: topRestaurants, error: restaurantsError } = await supabase
                    ...
                    .select('*')
                    .eq('status', 'approved')
                    .eq('review_count', maxReviewCount) as any;
                ...
                const sortedRestaurants = topRestaurants.sort((a: any, b: any) => {
        ...
        queryFn: async ({ pageParam = 0 }) => {
            ...
            try {
                const { data: reviewsData, error } = await supabase
                    ...
                    .range(pageParam, pageParam + 19) as any; // 한 페이지당 20개씩
