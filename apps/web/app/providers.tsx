...
function getQueryClient() {
    // AppRuntimeLayout is mounted per route segment, so a provider-local
    // QueryClient loses caches on bottom-nav navigation. Reuse one browser
    // client while keeping server renders request-local.
 ...
 * - 클라이언트 QueryClient를 재사용해 segment 이동 중 공통 데이터를 보존
 */
