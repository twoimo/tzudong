...
function HomeRuntimeProgressiveShell() {
    return (
        ...
        >
            ...
            <div className="absolute bottom-[calc(env(safe-area-inset-bottom)+92px)] left-1/2 w-[min(calc(100vw_-_32px),360px)] -translate-x-1/2 rounded-2xl bg-background/90 p-4 text-left shadow-xl shadow-black/10 backdrop-blur-sm min-[1280px]:bottom-8 min-[1280px]:left-8 min-[1280px]:translate-x-0">
