            ...
            {records.flatMap((record) => {
              ...
              const mainRow = (
                ...
                >
                  ...
                  <TableCell className="sticky left-12 bg-background group-hover:bg-muted/50 transition-colors">
                  ...
                  {/* 고정 컬럼: 상태 */}
                  <TableCell className="text-center sticky right-[180px] bg-background group-hover:bg-muted/50 transition-colors">
