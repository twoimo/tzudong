...
export function EvaluationDetailView({ record, className }: EvaluationDetailViewProps) {
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="pl-3 border-l-4 border-orange-500">
                                ...
                                <div className="text-gray-600 text-xs space-y-0.5 mt-0.5">
                                    <p><span className="text-gray-500">지번:</span> {record.jibun_address || '-'}</p>
                                    <p><span className="text-gray-500">도로명:</span> {record.road_address || '-'}</p>
                                </div>
                            </div>
                    ...
                    <div className="bg-white rounded-lg border p-3 shadow-sm">
                        ...
                        <div className="grid grid-cols-2 gap-x-4 gap-y-3">
                            ...
                            <div className="flex flex-col gap-0.5">
                                ...
                                <span className="font-semibold text-gray-900 text-sm break-keep">{record.restaurant_name || record.name || '-'}</span>
                            </div>
                            <div className="flex flex-col gap-0.5">
                                <span className="text-gray-500 text-xs font-medium">카테고리</span>
                                <span className="text-gray-900 text-sm">{record.restaurant_info?.category || '-'}</span>
                            </div>
                            ...
                            <div className="col-span-2 flex flex-col gap-0.5">
                                ...
                                <span className="text-gray-900 text-sm">{record.restaurant_info?.origin_address || '-'}</span>
                            </div>
                            ...
                            <div className="col-span-2 grid grid-cols-1 gap-1">
                                <div className="flex items-start gap-1.5">
                                    ...
                                    <span className="text-sm text-gray-700 break-all">{record.restaurant_info?.naver_address_info?.road_address || '-'}</span>
                                </div>
                                <div className="flex items-start gap-1.5">
                                    <Badge variant="outline" className="shrink-0 text-[10px] px-1 bg-green-50 text-green-700 border-green-200 h-5">Naver 지번</Badge>
                                    <span className="text-sm text-gray-700 break-all">{record.restaurant_info?.naver_address_info?.jibun_address || '-'}</span>
                                </div>
                            </div>
                        </div>
