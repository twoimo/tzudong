...
// ========== 인사이트 대시보드 스켈레톤 ==========
function InsightSkeletonComponent({ className }: { className?: string }) {
    return (
        <div className={cn("w-full max-w-6xl mx-auto p-4 md:p-6 space-y-6", className)} style={CONTAIN_STYLE}>
