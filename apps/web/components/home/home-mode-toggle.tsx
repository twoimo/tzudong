    ...
    return (
        <>
            ...
            <div className="lg:hidden fixed bottom-44 left-4 z-40">
                <div className="flex items-center gap-0.5 p-0.5 bg-background/95 backdrop-blur-sm rounded-full shadow-lg border border-border">
                    <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => onModeChange('domestic')}
                        className={`rounded-full h-8 px-2 text-xs font-medium transition-all ${mode === 'domestic'
                    ...
                    <Button
                        ...
                        className={`rounded-full h-8 px-2 text-xs font-medium transition-all ${mode === 'overseas'
                                ? 'bg-primary text-primary-foreground shadow-sm'
                                : 'text-muted-foreground hover:text-foreground hover:bg-transparent'
                            }`}
                    >
