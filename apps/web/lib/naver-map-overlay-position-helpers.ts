...
const MOBILE_BADGE_POSITION_CLASS =
    'fixed top-[calc(env(safe-area-inset-top)+132px)] left-1/2 -translate-x-1/2 transition-[left] duration-300 ease-in-out z-[61]';
...
const MOBILE_TOAST_POSITION_CLASS =
    'fixed top-[calc(env(safe-area-inset-top)+132px)] left-1/2 -translate-x-1/2 transition-[left] ease-in-out z-[70]';
