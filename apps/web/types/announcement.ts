...
export const DUMMY_ANNOUNCEMENTS: Announcement[] = [
    {
        ...
        title: '쯔동여지도 최신 업데이트 안내',
        content: `안녕하세요, 쯔동여지도입니다.

지도를 더 편하게 볼 수 있도록 최신 업데이트를 반영했습니다.

맛집 핀을 누르거나 좌우로 넘겨도, 예전에 보던 가게가 갑자기 다시 열리지 않습니다.
가까운 맛집이 묶여 있을 때는 그 주변 가게를 바로 확인할 수 있고, 휴대폰에서는 맛집을 고르면 아래 카드가 바로 열립니다.
뒤로 가기와 필터도 더 자연스럽게 동작합니다.

이용에 불편이 있었다면 이제 더 안정적으로 쓰실 수 있습니다. 감사합니다.`,
        isActive: true,
        showOnBanner: true,
        priority: 100,
