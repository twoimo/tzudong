...
describe('web quality performance source contracts', () => {
    ...
    test('home map runtime renders directly while supporting queries stay intent-gated', () => {
        ...
        expect(source('public/home-static.html')).toContain('<h1 class="title">홈 지도를 불러오는 중...</h1>');
        ...
        expect(source('public/home-static.html')).toContain('background:linear-gradient(90deg');
        expect(source('public/home-static.html')).toContain('홈 지도를 불러오는 중...');
        ...
        expect(source('app/home-initial-shell.tsx')).toContain('bg-gradient-to-r');
        ...
        expect(homeRuntimeShellSource).toContain('맛집 지도 런타임을 준비하고 있습니다');
        expect(homeRuntimeShellSource).toContain('bg-gradient-to-r');
