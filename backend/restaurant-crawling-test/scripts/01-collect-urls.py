...
# 유틸리티 모듈 경로 추가 (restaurant-crawling-test/)
...
env_paths = [
    ...
    Path(__file__).parent.parent.parent / ".env",  # restaurant-crawling/.env
]
...
LOG_DIR = Path(__file__).parent.parent.parent.parent / "log" / "restaurant-crawling"
