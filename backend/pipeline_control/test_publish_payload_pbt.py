...
def publish_inputs(draw: st.DrawFn) -> dict[str, Any]:
    ...
    def make_identity() -> dict[str, Any]:
        # Identity values are drawn independently; the subset/marker invariants
        # do not depend on identity uniqueness.
        return {key: draw(st.integers(min_value=1, max_value=10_000)) for key in identity_keys}
