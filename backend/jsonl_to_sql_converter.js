...
sql += 'INSERT INTO public.restaurants (name, address, phone, category, youtube_link, lat, lng, tzuyang_review) VALUES\n';
...
restaurants.forEach((restaurant, index) => {
  ...
  sql += `('${name}', '${address}', '${phone}', ${category}, '${youtube_link}', ${lat}, ${lng}, '${tzuyang_review}')`;
