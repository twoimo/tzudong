...
class G038SuccessorContractTests(unittest.TestCase):
    ...
    def test_manifest_requires_exact_ordered_parser_blob_parts(self):
        ...
        self.assertEqual(parser["tokenBlobParts"], ["db00843424", "6be335b9f7", "abaf0cb66a", "99a2b40378"])
        self.assertEqual(parser["stateBlobParts"], ["47775390d1", "731c0ad29e", "10b20fb2fe", "16c8cfcadb"])
        self.assertEqual(
            contract._parser_blob(parser["tokenBlobParts"], contract.TOKEN_BLOB_PARTS),
            "db00843424" + "6be335b9f7" + "abaf0cb66a" + "99a2b40378",
        )
        self.assertEqual(
            contract._parser_blob(parser["stateBlobParts"], contract.STATE_BLOB_PARTS),
            "47775390d1" + "731c0ad29e" + "10b20fb2fe" + "16c8cfcadb",
        )
