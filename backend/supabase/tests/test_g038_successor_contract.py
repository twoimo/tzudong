    ...
    def test_transaction_control_requires_none_then_exact_outer_begin_commit(self):
        ...
        payload = {
            ...
            "upstream": {
                ...
                "token": {"path": contract.PARSER_SPEC["tokenPath"], "blob": contract.PARSER_SPEC["tokenBlob"]},
                "state": {"path": contract.PARSER_SPEC["statePath"], "blob": contract.PARSER_SPEC["stateBlob"]},
            },
