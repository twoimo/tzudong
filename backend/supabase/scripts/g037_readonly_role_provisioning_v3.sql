-- G037 dedicated read-only role provisioning preview v3.
--
...
BEGIN
  ...
  IF target_function IS NULL
     ...
     OR parent_membership_count <> 0
     OR member_count <> 1
     OR current_user_member_count <> 1
     OR current_user_nonsuperuser_createrole_count <> 1
     OR superuser_grantor_count <> 1
     OR admin_option_count <> 1
     OR set_option_count <> 0
     OR inherit_option_count <> 0
