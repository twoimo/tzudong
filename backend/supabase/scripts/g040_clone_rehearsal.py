...
def _revalidate_observation_lineage(observation: Mapping[str, Any], repository_root: str | Path) -> Mapping[str, Any]:
    root = Path(repository_root).resolve()
    required = {"clone_nonce", "live_identity_sha256", "container_id_sha256", "image_id_sha256", "image_digest_sha256", "endpoint_sha256", "g035_restore_receipt_sha256", "g035_capture_receipt_sha256", "restored_archive_sha256", "capture_receipt_bytes_sha256", "restore_receipt_bytes_sha256", "archive_bytes", "g035_manifest_sha256", "source_sha256", "lineage_attestation_path", "lineage_signature_path", "lineage_attestation_sha256", "lineage_signature_sha256", "derivation_mode", "reverse_vector_sha256"}
    if not required <= set(observation) or type(observation["derivation_mode"]) is not str or type(observation["reverse_vector_sha256"]) is not str or observation["derivation_mode"] != DERIVATION_MODE or observation["reverse_vector_sha256"] != REVERSE_VECTOR_SHA256:
    ...
    if any(observation[key] != hashes[key] for key in hashes):
        _fail("reference_input")
    return MappingProxyType({key: observation[key] for key in ("clone_identity", "clone_nonce", "live_identity_sha256", "container_id_sha256", "image_id_sha256", "image_digest_sha256", "endpoint_sha256", "g035_restore_receipt_sha256", "g035_capture_receipt_sha256", "restored_archive_sha256", "capture_receipt_bytes_sha256", "restore_receipt_bytes_sha256", "lineage_attestation_sha256", "lineage_signature_sha256", "state", "ledger_prefix_sha256", "catalog_sha256", "data_sha256", "derivation_mode", "reverse_vector_sha256") if key in observation})
