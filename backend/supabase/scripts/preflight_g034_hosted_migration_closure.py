...
EXPECTED_IDENTITIES = (
    ("20260627080000", "storyboard_custom_gpt_rag_documents"), ("20260627153000", "storyboard_documents_hybrid_v2_indexes"), ("20260627154500", "storyboard_documents_hybrid_rrf_type_fix"), ("20260702000100", "restaurant_request_review_lifecycle"), ("20260704000100", "restaurant_submission_submit_contract"), ("20260704000200", "restaurant_destructive_admin_audit"), ("20260707000100", "admin_restaurant_map_overlays"), ("20260707000200", "admin_restaurant_map_overlay_audit_apply"), ("20260707000300", "admin_trend_schema_foundation"), ("20260707000400", "admin_trend_job_request_rpcs"), ("20260707000500", "admin_trend_proposal_review_rpc"), ("20260707000600", "admin_trend_proposal_approval_rpc"), ("20260711000100", "release_auth_session_revocation"), ("20260712000100", "g010_privacy_foundation"), ("20260712000200", "g010_notification_marketing"), ("20260712000300", "g010_account_deletion"), ("20260712000400", "g010_retention_separation"), ("20260712000500", "g010_incident_workflow"), ("20260712000600", "g010_ocr_log_minimization"), ("20260713000100", "g013_short_url_security"), ("20260713000200", "g013_ocr_quota_security"), ("20260713000300", "g013_admin_provider_budgets"), ("20260713000450", "g013_address_admin_approval"), ("20260713002000", "g014_public_api_private_boundary"), ("20260713002100", "g014_privacy_workflows"), ("20260713002300", "g014_account_deletion_state_machine"), ("20260713002400", "g014_retention_adapters_receipts"),
)
...
def validate_sources(manifest, report):
    ...
    if tuple(identities) != EXPECTED_IDENTITIES or versions != sorted(versions) or len(versions) != 27:
