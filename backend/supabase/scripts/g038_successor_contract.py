...
TOKEN_BLOB_PARTS = ("db008434246be335b9f7", "abaf0cb66a99a2b40378")
STATE_BLOB_PARTS = ("47775390d1731c0ad29e", "10b20fb2fe16c8cfcadb")
...
def _blob_parts(value: Any) -> tuple[str, str]:
    if (type(value) is not list or len(value) != 2
            or any(type(part) is not str or not _HEX20.fullmatch(part) for part in value)):
        _fail()
    return value[0], value[1]


def _parser_blob(value: Any, expected: tuple[str, str]) -> str:
