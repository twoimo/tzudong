...
--
-- Name: match_documents_bge(extensions.vector, double precision, integer, jsonb); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: match_documents_hybrid(extensions.vector, jsonb, double precision, double precision, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
BEGIN
    ...
    SELECT 
        ...
        r.review_count,
        GREATEST(
            extensions.similarity(r.name, search_query),
            extensions.similarity(COALESCE(r.road_address, ''), search_query),
            extensions.similarity(COALESCE(r.jibun_address, ''), search_query)
        ) AS similarity,
        
        -- 이름에 대한 Levenshtein 거리 계산
        extensions.levenshtein(r.name, search_query) AS edit_distance 
...
--
-- Name: search_video_ids_by_query(extensions.vector, jsonb, double precision, double precision, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: transcript_embeddings_bge_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.transcript_embeddings_bge ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.transcript_embeddings_bge_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: transcript_embeddings_bge transcript_embeddings_bge_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.transcript_embeddings_bge
    ADD CONSTRAINT transcript_embeddings_bge_pkey PRIMARY KEY (id);


--
-- Name: transcript_embeddings_bge transcript_embeddings_bge_unique_version; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.transcript_embeddings_bge
    ADD CONSTRAINT transcript_embeddings_bge_unique_version UNIQUE (video_id, chunk_index, recollect_id);
...
--
-- Name: document_embeddings document_embeddings_baseline_unique_version; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.document_embeddings
    ADD CONSTRAINT document_embeddings_baseline_unique_version UNIQUE (video_id, chunk_index, recollect_id);
...
CREATE INDEX idx_bge_embeddings_vector ON public.transcript_embeddings_bge USING hnsw (embedding extensions.vector_cosine_ops);
