...
| 3    | `gemini-2.5-pro`        | 백업                  |
| 4    | `gemini-2.5-flash`      | 최종 백업             |

> 쿼타 소진 시 자동으로 다음 모델로 전환됩니다.
...
### 쿼타 리셋 대기
```
[API Error: Your quota will reset after 3h29m52s]
```
- **30분 이하**: 즉시 대기 후 재시도
...
| 영역 | 최적화 내용 | 효과 |
| ---- | ----------- | ---- |
| File I/O | 50개마다 저장 (이전: 5개) | **90% 감소** |
| Rate Stats | 10개마다 저장 (이전: 매번) | **90% 감소** |
