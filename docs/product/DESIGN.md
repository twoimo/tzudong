...
- External production evidence remains required before enabling policy publication, Korean privacy review of a policy or retention change, location filing or non-applicability, guardian/provider approval, incident submission/receipt, retention activation, marketing send, and hosted migration/RLS/grant/RPC/type/catalog, backup/PITR, key-management, or operator-access changes. The sole operator may record their own decision. That record does not create a missing legal basis, period, provider, or hosted readback. Source safeguards do not prove any of those facts.
