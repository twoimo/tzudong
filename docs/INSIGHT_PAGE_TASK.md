...
- [ ] YouTube Data API 설정 및 영상 목록 가져오기
...
### 현재 사용 중인 모의 데이터 위치
- `HeatmapSection.tsx`: `MOCK_VIDEOS`, `MOCK_HEATMAP_DATA`
- `MapSection.tsx`: `MOCK_RESTAURANTS`
- `WordCloudSection.tsx`: `MOCK_KEYWORDS`, `MOCK_VIDEOS_BY_KEYWORD`
