...
### v2.1 (2025-10-21)
- ✅ **쯔동여지도여지도 리뷰 게시판 페이지 개발 완료** (ReviewsPage.tsx)
  - 리뷰 목록 표시 (게시판 형태)
  - 카테고리, 검색, 인증 상태별 필터링
  - 리뷰 정렬 (고정글 우선, 최신순)
- ✅ **리뷰 작성 모달 개발 완료** (ReviewModal.tsx)
  ...
  - 텍스트 에디터
  - 필수 항목 검증
- ✅ **쯔동여지도여지도 랭킹 페이지 개발 완료** (LeaderboardPage.tsx)
  - TOP 3 사용자 강조 표시
