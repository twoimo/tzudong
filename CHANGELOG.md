...
---
## 2026-08-26 — Docs layout

### Changed

- Cross-cutting docs now live under `docs/product/`, `docs/operations/`, and `docs/archive/handoffs/`. Root keeps README, LICENSE, AGENTS, SECURITY, and changelogs. Index: `docs/README.md`.
