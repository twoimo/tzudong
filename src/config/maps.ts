...
export const REGION_MAP_CONFIG = {
    ...
    "부산광역시": { center: [35.1796, 129.0756], zoom: 12 },
    "대구광역시": { center: [35.8714, 128.6014], zoom: 12 },
    "인천광역시": { center: [37.4563, 126.7052], zoom: 12 },
    ...
    "경기도": { center: [37.4138, 127.5183], zoom: 10 },
    "충청북도": { center: [36.6357, 127.4915], zoom: 10 },
    "충청남도": { center: [36.5184, 126.8000], zoom: 10 },
    "전라남도": { center: [34.8161, 126.4629], zoom: 10 },
    "경상북도": { center: [36.4919, 128.8889], zoom: 10 },
    "경상남도": { center: [35.4606, 128.2132], zoom: 10 },
    "전북특별자치도": { center: [35.7175, 127.1530], zoom: 10 },
    "제주특별자치도": { center: [33.4996, 126.5312], zoom: 11 },
    "경상북도 울릉군": { center: [37.4845, 130.9059], zoom: 13 }
} as const;
