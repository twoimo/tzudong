...
> AI Agent Context for Tzudong (쯔동여지도) Project
...
- **Language**: Korean for commits, PR titles, and user-facing content
- **Components**: Functional components only, no classes
- **Naming**: camelCase for variables, PascalCase for components
- **Imports**: Use path aliases (@/)
- **Error Handling**: Early returns, explicit error boundaries
